...
const App = () => {
    ...
    return (
        <>
            {
                !activities && !ytdStats && !allStats ? <div>Loading...</div> : (

                    <Grid container spacing={6} className={'main-grid'} style={{
                        width: '100vw',
                        height: '100vh',
                        margin: '0px',
                    }}>
                                    ...
                                    <StatsList
                                        ...
                                        listItems={[
                                            ...
                                            },
                                            {
                                                avatar: <TimerIcon/>,
                                                title: "Time:",
                                                subheader: `${Math.round(getHoursFromSeconds(ytdStats.moving_time))} hrs`
                                            },
                                            {
                                                avatar: <MapIcon/>,
                                                title: "Distance:",
                                                subheader: `${roundToTwoDecimalPlaces(getMilesFromMeters(ytdStats.distance))} mi`
                                            },
                                            {
                                                avatar: <LandscapeIcon/>,
                                                title: "Elevation Gain:",
                                                subheader: `${Math.round(getFeetFromMeters(ytdStats.elevation_gain))} ft`
                                            }
                                        ]}
                                    />
                                </Grid>
                                    ...
                                    <StatsList
                                        ...
                                        listItems={[
                                            ...
                                            },
                                            {
                                                avatar: <TimerIcon/>,
                                                title: "Time:",
                                                subheader: `${Math.round(getHoursFromSeconds(allStats.moving_time))} hrs`
                                            },
                                            {
                                                avatar: <MapIcon/>,
                                                title: "Distance:",
                                                subheader: `${roundToTwoDecimalPlaces(getMilesFromMeters(allStats.distance))} mi`
                                            },
                                            {
                                                avatar: <LandscapeIcon/>,
                                                title: "Elevation Gain:",
                                                subheader: `${Math.round(getFeetFromMeters(allStats.elevation_gain))} ft`
                                            }
                                        ]}
                                    />
                                </Grid>
